...
void Analysis_Template_MC::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup)
 {
   ...
   for(unsigned ifile=0;ifile<mFileName.size();ifile++){
     ...
     for (int i=0; i<nJetTrigList/2; i++){
       ...
       HLTJet[i] = trigtitle;
       sprintf(trigtitle, "HLT_PFJet%i_v5",HLTJetPtN[i]);
    ...
    */   
	 ...
	 for (int j=0; j<nJetTrig; j++){
	   ...
	   if (Event->fired(ihltj[j]) > 0) {
	     hltPassj[j] = true;
	     if(Event->preL1(ihltj[j])>=0){ 
             //prescalej[j] = Event->preL1(ihltj[j]) * Event->preHLT(ihltj[j]);
             prescalej[j] = 1;
         }
	     else { 
                //prescalej[j] = Event->preHLT(ihltj[j]);
                prescalej[j] = 1;
         }
	 ...
	 for(unsigned int j=0; j<Event->nPFJetsCHS(); j++) {
	   ...
	   if(Event->pfjetchs(j).ptCor()>=mMinPt){
	     ...
	     if(Event->pfjetchs(0).ptCor()>=mMinPt && Event->pfjetchs(0).ptCor()<74 && (hltPassj[0] || hltPassj[24])){
	     	       
	       if(hltPassj[0]){ if(prescalej[0]>0) hweight=hweight*prescalej[0]; if(prescalej[0]<0) hweight=hweight*(-prescalej[0]);}
	       if(hltPassj[24]){ if(prescalej[10]>0) hweight=hweight*prescalej[10]; if(prescalej[10]<0) hweight=hweight*(-prescalej[10]);}
	    ...
	    hweight = 1.00;  
        /*
        pt_DETInclJet_1bin->Scale(1.00/0.022);
        pt_DETInclJet_2bin->Scale(1.00/0.022);
        pt_DETInclJet_3bin->Scale(1.00/0.022);
        pt_DETInclJet_4bin->Scale(1.00/0.022);
        pt_DETInclJet_5bin->Scale(1.00/0.022);
        pt_DETInclJet_6bin->Scale(1.00/0.022);
        pt_DETInclJet_7bin->Scale(1.00/0.022);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=74 && Event->pfjetchs(0).ptCor()<110 && (hltPassj[0] || hltPassj[10])){
        ...
        pt_DETInclJetUP_1bin->Scale(1.00/0.022);
        pt_DETInclJetUP_2bin->Scale(1.00/0.022);
        pt_DETInclJetUP_3bin->Scale(1.00/0.022);
        pt_DETInclJetUP_4bin->Scale(1.00/0.022);
        pt_DETInclJetUP_5bin->Scale(1.00/0.022);
        pt_DETInclJetUP_6bin->Scale(1.00/0.022);
        pt_DETInclJetUP_7bin->Scale(1.00/0.022);

        pt_DETInclJetDOWN_1bin->Scale(1.00/0.022);
        pt_DETInclJetDOWN_2bin->Scale(1.00/0.022);
        pt_DETInclJetDOWN_3bin->Scale(1.00/0.022);
        pt_DETInclJetDOWN_4bin->Scale(1.00/0.022);
        pt_DETInclJetDOWN_5bin->Scale(1.00/0.022);
        pt_DETInclJetDOWN_6bin->Scale(1.00/0.022);
        pt_DETInclJetDOWN_7bin->Scale(1.00/0.022);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=110 && Event->pfjetchs(0).ptCor() < 135 && (hltPassj[1] || hltPassj[11])){
	       //if(hltPassj[2]) { if(prescalej[2]>0) hweight=hweight*prescalej[2]; if(prescalej[2]<0) hweight=hweight*(-prescalej[2]);}
	       //if(hltPassj[12]) { if(prescalej[12]>0) hweight=hweight*prescalej[12]; if(prescalej[12]<0) hweight=hweight*(-prescalej[12]);}
           if(hltPassj[1]) { if(prescalej[1]>0) hweight=hweight*prescalej[1]; if(prescalej[1]<0) hweight=hweight*(-prescalej[1]);}
	       if(hltPassj[11]) { if(prescalej[11]>0) hweight=hweight*prescalej[11]; if(prescalej[11]<0) hweight=hweight*(-prescalej[11]);}
        ...
        /*
        pt_DETInclJet_1bin->Scale(1.00/0.079);
        pt_DETInclJet_2bin->Scale(1.00/0.079);
        pt_DETInclJet_3bin->Scale(1.00/0.079);
        pt_DETInclJet_4bin->Scale(1.00/0.079);
        pt_DETInclJet_5bin->Scale(1.00/0.079);
        pt_DETInclJet_6bin->Scale(1.00/0.079);
        pt_DETInclJet_7bin->Scale(1.00/0.079);

        pt_DETInclJetUP_1bin->Scale(1.00/0.079);
        pt_DETInclJetUP_2bin->Scale(1.00/0.079);
        pt_DETInclJetUP_3bin->Scale(1.00/0.079);
        pt_DETInclJetUP_4bin->Scale(1.00/0.079);
        pt_DETInclJetUP_5bin->Scale(1.00/0.079);
        pt_DETInclJetUP_6bin->Scale(1.00/0.079);
        pt_DETInclJetUP_7bin->Scale(1.00/0.079);

        pt_DETInclJetDOWN_1bin->Scale(1.00/0.079);
        pt_DETInclJetDOWN_2bin->Scale(1.00/0.079);
        pt_DETInclJetDOWN_3bin->Scale(1.00/0.079);
        pt_DETInclJetDOWN_4bin->Scale(1.00/0.079);
        pt_DETInclJetDOWN_5bin->Scale(1.00/0.079);
        pt_DETInclJetDOWN_6bin->Scale(1.00/0.079);
        pt_DETInclJetDOWN_7bin->Scale(1.00/0.079);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=135 && Event->pfjetchs(0).ptCor()<220 && (hltPassj[2] || hltPassj[12])){
	       //if(hltPassj[3]) { if(prescalej[3]>0) hweight=hweight*prescalej[3]; if(prescalej[3]<0) hweight=hweight*(-prescalej[3]);}
	       //if(hltPassj[13]) { if(prescalej[13]>0) hweight=hweight*prescalej[13]; if(prescalej[13]<0) hweight=hweight*(-prescalej[13]);}
	       if(hltPassj[2]) { if(prescalej[2]>0) hweight=hweight*prescalej[2]; if(prescalej[2]<0) hweight=hweight*(-prescalej[2]);}
	       if(hltPassj[12]) { if(prescalej[12]>0) hweight=hweight*prescalej[12]; if(prescalej[12]<0) hweight=hweight*(-prescalej[12]);}
         ...
         //scale by effective lumi
        /*
        pt_DETInclJet_1bin->Scale(1.00/0.518);
        pt_DETInclJet_2bin->Scale(1.00/0.518);
        pt_DETInclJet_3bin->Scale(1.00/0.518);
        pt_DETInclJet_4bin->Scale(1.00/0.518);
        pt_DETInclJet_5bin->Scale(1.00/0.518);
        pt_DETInclJet_6bin->Scale(1.00/0.518);
        pt_DETInclJet_7bin->Scale(1.00/0.518);

        pt_DETInclJetUP_1bin->Scale(1.00/0.518);
        pt_DETInclJetUP_2bin->Scale(1.00/0.518);
        pt_DETInclJetUP_3bin->Scale(1.00/0.518);
        pt_DETInclJetUP_4bin->Scale(1.00/0.518);
        pt_DETInclJetUP_5bin->Scale(1.00/0.518);
        pt_DETInclJetUP_6bin->Scale(1.00/0.518);
        pt_DETInclJetUP_7bin->Scale(1.00/0.518);

        pt_DETInclJetDOWN_1bin->Scale(1.00/0.518);
        pt_DETInclJetDOWN_2bin->Scale(1.00/0.518);
        pt_DETInclJetDOWN_3bin->Scale(1.00/0.518);
        pt_DETInclJetDOWN_4bin->Scale(1.00/0.518);
        pt_DETInclJetDOWN_5bin->Scale(1.00/0.518);
        pt_DETInclJetDOWN_6bin->Scale(1.00/0.518);
        pt_DETInclJetDOWN_7bin->Scale(1.00/0.518);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=220 && Event->pfjetchs(0).ptCor()<310 && (hltPassj[3] || hltPassj[13])){
	       //if(hltPassj[4]) { if(prescalej[4]>0) hweight=hweight*prescalej[4]; if(prescalej[4]<0) hweight=hweight*(-prescalej[4]);}
	       //if(hltPassj[14]) { if(prescalej[14]>0) hweight=hweight*prescalej[14]; if(prescalej[14]<0) hweight=hweight*(-prescalej[14]);}
	       if(hltPassj[3]) { if(prescalej[3]>0) hweight=hweight*prescalej[3]; if(prescalej[3]<0) hweight=hweight*(-prescalej[3]);}
	       if(hltPassj[13]) { if(prescalej[13]>0) hweight=hweight*prescalej[13]; if(prescalej[13]<0) hweight=hweight*(-prescalej[13]);}
         ...
         //scale by effective lumi
        /*
        pt_DETInclJet_1bin->Scale(1.00/3.442);
        pt_DETInclJet_2bin->Scale(1.00/3.442);
        pt_DETInclJet_3bin->Scale(1.00/3.442);
        pt_DETInclJet_4bin->Scale(1.00/3.442);
        pt_DETInclJet_5bin->Scale(1.00/3.442);
        pt_DETInclJet_6bin->Scale(1.00/3.442);
        pt_DETInclJet_7bin->Scale(1.00/3.442);

        pt_DETInclJetUP_1bin->Scale(1.00/3.442);
        pt_DETInclJetUP_2bin->Scale(1.00/3.442);
        pt_DETInclJetUP_3bin->Scale(1.00/3.442);
        pt_DETInclJetUP_4bin->Scale(1.00/3.442);
        pt_DETInclJetUP_5bin->Scale(1.00/3.442);
        pt_DETInclJetUP_6bin->Scale(1.00/3.442);
        pt_DETInclJetUP_7bin->Scale(1.00/3.442);

        pt_DETInclJetDOWN_1bin->Scale(1.00/3.442);
        pt_DETInclJetDOWN_2bin->Scale(1.00/3.442);
        pt_DETInclJetDOWN_3bin->Scale(1.00/3.442);
        pt_DETInclJetDOWN_4bin->Scale(1.00/3.442);
        pt_DETInclJetDOWN_5bin->Scale(1.00/3.442);
        pt_DETInclJetDOWN_6bin->Scale(1.00/3.442);
        pt_DETInclJetDOWN_7bin->Scale(1.00/3.442);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=310 && Event->pfjetchs(0).ptCor()<380 && (hltPassj[4] || hltPassj[14])){
        ...
        /*
         //scale by effective lumi
        pt_DETInclJet_1bin->Scale(1.00/16.049);
        pt_DETInclJet_2bin->Scale(1.00/16.049);
        pt_DETInclJet_3bin->Scale(1.00/16.049);
        pt_DETInclJet_4bin->Scale(1.00/16.049);
        pt_DETInclJet_5bin->Scale(1.00/16.049);
        pt_DETInclJet_6bin->Scale(1.00/16.049);
        pt_DETInclJet_7bin->Scale(1.00/16.049);

        pt_DETInclJetUP_1bin->Scale(1.00/16.049);
        pt_DETInclJetUP_2bin->Scale(1.00/16.049);
        pt_DETInclJetUP_3bin->Scale(1.00/16.049);
        pt_DETInclJetUP_4bin->Scale(1.00/16.049);
        pt_DETInclJetUP_5bin->Scale(1.00/16.049);
        pt_DETInclJetUP_6bin->Scale(1.00/16.049);
        pt_DETInclJetUP_7bin->Scale(1.00/16.049);

        pt_DETInclJetDOWN_1bin->Scale(1.00/16.049);
        pt_DETInclJetDOWN_2bin->Scale(1.00/16.049);
        pt_DETInclJetDOWN_3bin->Scale(1.00/16.049);
        pt_DETInclJetDOWN_4bin->Scale(1.00/16.049);
        pt_DETInclJetDOWN_5bin->Scale(1.00/16.049);
        pt_DETInclJetDOWN_6bin->Scale(1.00/16.049);
        pt_DETInclJetDOWN_7bin->Scale(1.00/16.049);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=380 && Event->pfjetchs(0).ptCor()<474 && (hltPassj[5] || hltPassj[15])){
        ...
        hweight = 1.00;
         //scale by effective lumi
        /*
        pt_DETInclJet_1bin->Scale(1.00/71.212);
        pt_DETInclJet_2bin->Scale(1.00/71.212);
        pt_DETInclJet_3bin->Scale(1.00/71.212);
        pt_DETInclJet_4bin->Scale(1.00/71.212);
        pt_DETInclJet_5bin->Scale(1.00/71.212);
        pt_DETInclJet_6bin->Scale(1.00/71.212);
        pt_DETInclJet_7bin->Scale(1.00/71.212);

        pt_DETInclJetUP_1bin->Scale(1.00/71.212);
        pt_DETInclJetUP_2bin->Scale(1.00/71.212);
        pt_DETInclJetUP_3bin->Scale(1.00/71.212);
        pt_DETInclJetUP_4bin->Scale(1.00/71.212);
        pt_DETInclJetUP_5bin->Scale(1.00/71.212);
        pt_DETInclJetUP_6bin->Scale(1.00/71.212);
        pt_DETInclJetUP_7bin->Scale(1.00/71.212);

        pt_DETInclJetDOWN_1bin->Scale(1.00/71.212);
        pt_DETInclJetDOWN_2bin->Scale(1.00/71.212);
        pt_DETInclJetDOWN_3bin->Scale(1.00/71.212);
        pt_DETInclJetDOWN_4bin->Scale(1.00/71.212);
        pt_DETInclJetDOWN_5bin->Scale(1.00/71.212);
        pt_DETInclJetDOWN_6bin->Scale(1.00/71.212);
        pt_DETInclJetDOWN_7bin->Scale(1.00/71.212);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=474 && Event->pfjetchs(0).ptCor()<580 && (hltPassj[6] || hltPassj[16])){
        ...
        hweight = 1.00/216.850;
         ...
         /*
        //scale by effective lumi
        pt_DETInclJet_1bin->Scale(1.00/216.850);
        pt_DETInclJet_2bin->Scale(1.00/216.850);
        pt_DETInclJet_3bin->Scale(1.00/216.850);
        pt_DETInclJet_4bin->Scale(1.00/216.850);
        pt_DETInclJet_5bin->Scale(1.00/216.850);
        pt_DETInclJet_6bin->Scale(1.00/216.850);
        pt_DETInclJet_7bin->Scale(1.00/216.850);

        pt_DETInclJetUP_1bin->Scale(1.00/216.850);
        pt_DETInclJetUP_2bin->Scale(1.00/216.850);
        pt_DETInclJetUP_3bin->Scale(1.00/216.850);
        pt_DETInclJetUP_4bin->Scale(1.00/216.850);
        pt_DETInclJetUP_5bin->Scale(1.00/216.850);
        pt_DETInclJetUP_6bin->Scale(1.00/216.850);
        pt_DETInclJetUP_7bin->Scale(1.00/216.850);

        pt_DETInclJetDOWN_1bin->Scale(1.00/216.850);
        pt_DETInclJetDOWN_2bin->Scale(1.00/216.850);
        pt_DETInclJetDOWN_3bin->Scale(1.00/216.850);
        pt_DETInclJetDOWN_4bin->Scale(1.00/216.850);
        pt_DETInclJetDOWN_5bin->Scale(1.00/216.850);
        pt_DETInclJetDOWN_6bin->Scale(1.00/216.850);
        pt_DETInclJetDOWN_7bin->Scale(1.00/216.850);
        */
	     ...
	     if(Event->pfjetchs(0).ptCor()>=580 && Event->pfjetchs(0).ptCor() < 640 && (hltPassj[7] || hltPassj[17])){
	   ...
	   if((fabs(Event->pfjetchs(j).y())<=3.0 && Event->pfjetchs(j).tightID())||(fabs(Event->pfjetchs(j).y())>3.2 && Event->pfjetchs(j).nemf()<0.90 && Event->pfjetchs(j).ncand()>10)){
        ...
        /*
        //scale by effective lumi
        pt_DETInclJet_1bin->Scale(1.00/591.231);
        pt_DETInclJet_2bin->Scale(1.00/591.231);
        pt_DETInclJet_3bin->Scale(1.00/591.231);
        pt_DETInclJet_4bin->Scale(1.00/591.231);
        pt_DETInclJet_5bin->Scale(1.00/591.231);
        pt_DETInclJet_6bin->Scale(1.00/591.231);
        pt_DETInclJet_7bin->Scale(1.00/591.231);

        pt_DETInclJetUP_1bin->Scale(1.00/591.231);
        pt_DETInclJetUP_2bin->Scale(1.00/591.231);
        pt_DETInclJetUP_3bin->Scale(1.00/591.231);
        pt_DETInclJetUP_4bin->Scale(1.00/591.231);
        pt_DETInclJetUP_5bin->Scale(1.00/591.231);
        pt_DETInclJetUP_6bin->Scale(1.00/591.231);
        pt_DETInclJetUP_7bin->Scale(1.00/591.231);

        pt_DETInclJetDOWN_1bin->Scale(1.00/591.231);
        pt_DETInclJetDOWN_2bin->Scale(1.00/591.231);
        pt_DETInclJetDOWN_3bin->Scale(1.00/591.231);
        pt_DETInclJetDOWN_4bin->Scale(1.00/591.231);
        pt_DETInclJetDOWN_5bin->Scale(1.00/591.231);
        pt_DETInclJetDOWN_6bin->Scale(1.00/591.231);
        pt_DETInclJetDOWN_7bin->Scale(1.00/591.231);
        */
	   ...
	   if(Event->pfjetchs(0).ptCor()>=640 && (hltPassj[8] || hltPassj[18])){
         //if(Event->pfjetchs(0).ptCor()>=800 && hltPassj[8]){
         if(hltPassj[8]){ if(prescalej[8]>0) hweight=hweight*prescalej[8]; if(prescalej[8]<0) hweight=hweight*(-prescalej[8]);}
         if(hltPassj[18]){ if(prescalej[18]>0) hweight=hweight*prescalej[18]; if(prescalej[18]<0) hweight=hweight*(-prescalej[18]); }
     ...
     {pt_DETInclJet_7bin->Fill(Event->pfjetchs(j).ptCor(),hweight);pt_DETInclJetUP_7bin->Fill(Event->pfjetchs(j).ptCor()+Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).uncSrc(0),hweight);pt_DETInclJetDOWN_7bin->Fill(Event->pfjetchs(j).ptCor()-Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).uncSrc(0),hweight);}
       ...
       //scale by effective lumi
        /*
        pt_DETInclJet_1bin->Scale(1.00/2942.044);
        pt_DETInclJet_2bin->Scale(1.00/2942.044);
        pt_DETInclJet_3bin->Scale(1.00/2942.044);
        pt_DETInclJet_4bin->Scale(1.00/2942.044);
        pt_DETInclJet_5bin->Scale(1.00/2942.044);
        pt_DETInclJet_6bin->Scale(1.00/2942.044);
        pt_DETInclJet_7bin->Scale(1.00/2942.044);

        pt_DETInclJetUP_1bin->Scale(1.00/2942.044);
        pt_DETInclJetUP_2bin->Scale(1.00/2942.044);
        pt_DETInclJetUP_3bin->Scale(1.00/2942.044);
        pt_DETInclJetUP_4bin->Scale(1.00/2942.044);
        pt_DETInclJetUP_5bin->Scale(1.00/2942.044);
        pt_DETInclJetUP_6bin->Scale(1.00/2942.044);
        pt_DETInclJetUP_7bin->Scale(1.00/2942.044);

        pt_DETInclJetDOWN_1bin->Scale(1.00/2942.044);
        pt_DETInclJetDOWN_2bin->Scale(1.00/2942.044);
        pt_DETInclJetDOWN_3bin->Scale(1.00/2942.044);
        pt_DETInclJetDOWN_4bin->Scale(1.00/2942.044);
        pt_DETInclJetDOWN_5bin->Scale(1.00/2942.044);
        pt_DETInclJetDOWN_6bin->Scale(1.00/2942.044);
        pt_DETInclJetDOWN_7bin->Scale(1.00/2942.044);
        */

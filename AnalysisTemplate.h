...
class Analysis_Template_MC : public edm::EDAnalyzer
 {
  ...
  private:
    ...
    TH1F *ptPair_DETBTagJet;

    TH1F *pt0_DETBTagJetInclusive;
    ...
    TH1F *TCHP_DET;
    TH1F *TCHE_DET;
    TH1F *SimpleSecVertexHE_DET;
    TH1F *SimpleSecVertexHP_DET;

    TH1F *Multiplicity_DETJetBTagsInclusive;
    TH1F *Multiplicity_DETJetBTags;
    ...
    TH1F* pt_DETBTagJet_1bin;
    TH1F* pt_DETBTagJet_2bin;
    TH1F* pt_DETBTagJet_3bin;
    TH1F* pt_DETBTagJet_4bin;
    TH1F* pt_DETBTagJet_5bin;
    TH1F* pt_DETBTagJet_6bin;
    TH1F* pt_DETBTagJet_7bin;
    ...
    TH1F* pt_GENBTagJet_1bin;
    TH1F* pt_GENBTagJet_2bin;
    TH1F* pt_GENBTagJet_3bin;
    TH1F* pt_GENBTagJet_4bin;
    TH1F* pt_GENBTagJet_5bin;
    TH1F* pt_GENBTagJet_6bin;
    TH1F* pt_GENBTagJet_7bin;

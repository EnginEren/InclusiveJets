   ...
   for(unsigned ifile=0;ifile<mFileName.size();ifile++){
	 ...
	 for(unsigned j=0; j< Event->nPFJetsCHS(); ++j){
	   ...
	   if(Event->pfjetchs(j).ptCor() >= 20){
	     ...
	     if(fabs(Event->pfjetchs(j).y())<=0.5 && Event->pfjetchs(j).tightID() && Event->pfmet().met_o_sumet() < 0.3) {pt_DETInclJet_1bin->Fill(Event->pfjetchs(j).ptCor(),hweight); pt_DETInclJetUP_1bin->Fill(Event->pfjetchs(j).ptCor()+Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);pt_DETInclJetDOWN_1bin->Fill(Event->pfjetchs(j).ptCor()-Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);}
	     ...
	     if(fabs(Event->pfjetchs(j).y())>1.5 && fabs(Event->pfjetchs(j).y())<=2.0 && Event->pfjetchs(j).tightID() && Event->pfmet().met_o_sumet() < 0.3) {pt_DETInclJet_4bin->Fill(Event->pfjetchs(j).ptCor(),hweight);pt_DETInclJetUP_4bin->Fill(Event->pfjetchs(j).ptCor()+Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);pt_DETInclJetDOWN_4bin->Fill(Event->pfjetchs(j).ptCor()-Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);}
	     if(fabs(Event->pfjetchs(j).y())>2.0 && fabs(Event->pfjetchs(j).y())<=2.5 && Event->pfjetchs(j).tightID() && Event->pfmet().met_o_sumet() < 0.3) {pt_DETInclJet_5bin->Fill(Event->pfjetchs(j).ptCor(),hweight);pt_DETInclJetUP_5bin->Fill(Event->pfjetchs(j).ptCor()+Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);pt_DETInclJetDOWN_5bin->Fill(Event->pfjetchs(j).ptCor()-Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);}
	     if(fabs(Event->pfjetchs(j).y())>2.5 && fabs(Event->pfjetchs(j).y())<=3.0 && Event->pfjetchs(j).tightID() && Event->pfmet().met_o_sumet() < 0.3) {pt_DETInclJet_6bin->Fill(Event->pfjetchs(j).ptCor(),hweight);pt_DETInclJetUP_6bin->Fill(Event->pfjetchs(j).ptCor()+Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);pt_DETInclJetDOWN_6bin->Fill(Event->pfjetchs(j).ptCor()-Event->pfjetchs(j).ptCor()*Event->pfjetchs(j).unc(),hweight);}
